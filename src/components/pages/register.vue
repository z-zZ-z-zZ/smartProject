    ...
    <div class="page" id="app">
      ...
      <div class="main">
        <form action="#">
          ...
          <label>手机号:<input type="text" name="tel" /></label>
          <label>密码:<input type="text" name="pwd" /></label>
          <label
            >验证码:<input type="text" name="ver" />
            <a href="javasctipt:;">重新发送</a></label
          >
          <input type="button" value="下一步" />
          <label
            ><input type="checkbox" />我已阅读并同意<a href="javascript:;"
              >使用条款</a
...
.left {
  ...
  width: 0.17rem;
  height: 0.29rem;
  background: url("../../assets/images/arrowLeft_2.jpg") no-repeat center;
